class Rope
  ...
  //Composites.stack function is used to create multiple rectangles. Now we need to create a chain of the rectangles
  ...
  World.add(engine.world, this.body);
     ...
     // Constraint is used to attach all the bodies together. 
